...
#
# This file is copied and adjusted from
# https://github.com/zsh-users/zsh/blob/43247252ddeedcf3955b030f2c77064089581cb0/Test/ztst.zsh
# - it's used for internal zsh testing, but I'm adapting it to test
# the sexp navigation widgets instead.
#
...
# (Changed by asf) Set the function autoload paths to be the source directory
fpath=( $ZTST_srcdir/.. )
